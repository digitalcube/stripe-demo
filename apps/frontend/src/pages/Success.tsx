...
export const PageSuccess: FC = () => {
    ...
    return (
        <Container>
          <PostHeader title={"Thank You!!"} subtitle={"You complete to subscribe the plan!"} />
          <Container
            size="1"
            sx={{
              my: 4,
          ...
          >
            ...
            >
                ...
                <p><a href={portal} target="_blank" rel="noopener noreferrer">{portal}</a></p>
                <p>The URL is temporary.When the URL expired, you need to create again.</p>
            </Content>
          </Container>
        </Container>
    )
