...
export class AppService {
  ...
  public async listPrices() {
    ...
    const results = await Promise.all(products.map(async product => {
      ...
      return {
        ...product,
        prices: prices.filter(price => price.active).map(({
          id,
          nickname,
          unit_amount,
          unit_amount_decimal,
  ...
  public async createCustomer(params?: Stripe.CustomerCreateParams, options?: Stripe.RequestOptions) {
    return this.stripe.customers.create(params, options)
  }
  public async launchPortal(params: Stripe.BillingPortal.SessionCreateParams, options?: Stripe.RequestOptions) {
  ...
  public async createSubscription(params: Stripe.SubscriptionCreateParams, options?: Stripe.RequestOptions) {
